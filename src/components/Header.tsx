...
const Header = () => {
  ...
  return <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <h1 className="text-xl font-bold text-primary cursor-pointer hover:opacity-80 transition-opacity" onClick={() => navigate('/')}>Já que é Natal - Orçamentos</h1>
          ...
          {profile ? <>
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>
                  ...
                  {profile.role === 'admin' && <span className="text-primary ml-1">(Admin)</span>}
                </span>
              </div>
              ...
              <Button variant="outline" size="sm" onClick={() => navigate('/login?tab=signin')}>
                Entrar
              </Button>
